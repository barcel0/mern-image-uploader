...
const ImageUpload = (props) => {
  ...
  const handleSubmitClick = (e, formData, options) => {
    setFilename('Choose Image');
    handleSubmit(e, formData, options);
  }

  return (
    <form onSubmit={(e) => handleSubmitClick(e, formData, options)} style={{ width: '280px' }} className="mt-3">
